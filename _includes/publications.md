...
<ol class="bibliography">
  ...
  <!-- Journal Articles       -->
  <!-- ===================== -->
  <h3 style="margin-top: 25px;">Journal Articles</h3>

  {% for link in site.data.publications.journal_articles %}
  ...
  <!-- Thesis                 -->
  <!-- ===================== -->
  <h3 style="margin-top: 25px;">PhD Thesis</h3>

  {% for link in site.data.publications.phd_thesis %}
